# Scheduling Bounded Context API Service
...
| SVC_CLIENT_ID        | Service client ID                 | scheduling-bc-scheduling-api-svc              |
| SVC_CLIENT_SECRET    | Service client secret             | superServiceSecret     |
| SVC_DEFAULT_HTTP_PORT                 | Default HTTP port for the service                  | 3150  |
